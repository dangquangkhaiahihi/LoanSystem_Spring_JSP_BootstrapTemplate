...
<head>
    ...
    <title>Danh sách đang nợ</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Xem các khoản đang nợ</h1>
                                    ...
                                    <td>
                                        <div>
                                            <button class="btn btn-transaprent btn-icon btn-sm"
                                                    data-toggle="modal" data-target="#modal-trace-paid-debt"
                                                    data-tooltip="tooltip" title="Trả nợ"
                                                    onclick='captrueCurrentId(<%=trace.getId()%>)' >
                                                <img src="../../img/icon/24x24-money.svg" alt=""
                                                     class="btn-icon"/>
                                            </button>
                                        </div>
                                    </td>
...
<%@ include file="../../modal/trace/modal-paid-trace-debt.jsp" %>
...
<script>
    function captrueCurrentId(id) {
        document.getElementById("trace-id-paid-debt").value = id;
    }
</script>
</body>
