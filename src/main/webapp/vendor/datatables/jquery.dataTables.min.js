...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Tiếp",sPrevious:"Trước"},sEmptyTable:"Không tìm thấy bản ghi thỏa mãn điều kiện",sInfo:"Từ _START_ đến _END_ của _TOTAL_ bản ghi",sInfoEmpty:"Từ 0 đến 0 của 0 bản ghi",
sInfoFiltered:"(Lọc trong tổng số _MAX_ bản ghi)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Xem _MENU_ bản ghi",sLoadingRecords:"Đang tải...",sProcessing:"Processing...",sSearch:"Tìm nhanh:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy bản ghi hợp lệ."},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
